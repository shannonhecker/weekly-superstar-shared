...
export const shadowsCss = {
  card: '0 1px 2px rgba(17, 24, 39, 0.03), 0 2px 6px rgba(17, 24, 39, 0.03)',
  pop: '0 8px 24px rgba(17, 24, 39, 0.06)',
  // Earthy elevations — cocoa-tinted, three-step
  earthyFlat:   'none',
  earthySoft:   '0 1px 2px rgba(90, 58, 46, 0.04), 0 4px 12px rgba(90, 58, 46, 0.03)',
  earthyLifted: '0 8px 24px rgba(90, 58, 46, 0.07)',
} as const

export const shadowsRn = {
  card: '0 2px 6px rgba(17, 24, 39, 0.03)',
  pop: '0 8px 24px rgba(17, 24, 39, 0.06)',
  earthyFlat: 'none',
  earthySoft: '0 4px 12px rgba(90, 58, 46, 0.04)',
  earthyLifted: '0 8px 24px rgba(90, 58, 46, 0.07)',
} as const
